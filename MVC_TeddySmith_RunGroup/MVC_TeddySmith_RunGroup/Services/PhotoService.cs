...
namespace MVC_TeddySmith_RunGroup.Services
{
    public class PhotoService : IPhotoService  //IPhotoService inherit ettiğimizde bu interfaceyi implement etmeliyiz (public Task<ImageUploadResult> AddPhotoAsync(IFormFile file) ...)
    {
