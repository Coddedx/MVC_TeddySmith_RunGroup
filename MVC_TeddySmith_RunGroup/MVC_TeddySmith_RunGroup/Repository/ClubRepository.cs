...
{
    public class ClubRepository :IClubRepository //this is repository cuse we mostly pulling from the data base
    {

        private readonly ApplicationDbContext _context; 

        public ClubRepository(ApplicationDbContext context) //with the all repository we need constructor
        {
            _context = context;
        }
